	...
	protected function beforeSave()
{
	...
	public function rules()
	{
		...
		return array(
            array('notes_name, notes_value, notes_author', 'required'),
	...
	public function search()
	{
		...
		$criteria->compare('notes_author',$this->notes_author,true);
		$criteria->compare('notes_update',$this->notes_update,true);
